...
** Last update Sun Dec 16 13:56:43 2012 pelayo parejopagador
*/
...
int		fill_translation(int *, char *, char *);
int		fill_homothety(int *, char *, char *);
int		fill_rotation(int *, char *);
int		*fill_symmetry(char *);
...
void		calc_manager(int **, int);
void		vector_calc(int **, char **, int, t_point *);
void		print_manager(int *, char **, int);
void		print_matrix_float(int *, long);
